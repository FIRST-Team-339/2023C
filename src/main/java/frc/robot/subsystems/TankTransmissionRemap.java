...
public class TankTransmissionRemap extends SubsystemBase
    {
    ...
    public TankTransmissionRemap()
        {
            ...
            // NEEDS UNIQUE NAMES
            // this.tankTransmission = new
            // frc.HardwareInterfaces.Transmission.TankTransmission(leftMotorGroup,
            // rightMotorGroup);
    ...
    public void drive(double leftSideVal, double rightSideVal)
    {
        ...
        double rightOut = rightSide.scaleJoystickForDeadband(rightSideVal)
                * rightSide.getCurrentGearRatio();
