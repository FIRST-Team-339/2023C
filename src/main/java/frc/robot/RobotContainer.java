...
public class RobotContainer {
    ...
    /* Buttons */
    private final JoystickButton gearUpButton = new JoystickButton(leftDriver, Constants.TwentyThree.GEAR_UP_BUTTON);
    ...
    public RobotContainer(){
        ...
        gearUpButton.toggleOnTrue(Commands.runOnce(tankTransmission::gearUp));
        gearDownButton.toggleOnTrue(Commands.runOnce(tankTransmission::gearDown));
